...
tree["columns"] = ("name", "age", "sex", "course", "subjects")
tree.column("#0", width=0, stretch=NO)
tree.column("name", anchor=W, width=100)
tree.column("age", anchor=W, width=50)
tree.column("sex", anchor=W, width=50)
tree.column("course", anchor=W, width=100)
tree.column("subjects", anchor=W, width=200)
tree.heading("#0", text="", anchor=W)
tree.heading("name", text="Name", anchor=W)
tree.heading("age", text="Age", anchor=W)
tree.heading("sex", text="Sex", anchor=W)
tree.heading("course", text="Course", anchor=W)
tree.heading("subjects", text="Subjects", anchor=W)
tree.pack()
